...
class TestAssetDownloader(unittest.TestCase):
    ...
    def test_download_success(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            result = self.downloader.download("images/test.jpg", save_dir, "image")
    ...
    def test_download_failure_status(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            result = self.downloader.download("images/missing.jpg", Path(tmp_dir))
    ...
    def test_download_exception(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            result = self.downloader.download("images/test.jpg", Path(tmp_dir))
    ...
    def test_download_with_different_base_url(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            result = downloader.download("image.jpg", Path(tmp_dir))
